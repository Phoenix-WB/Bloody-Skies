...
public class BloodAltarEntity extends RandomizableContainerBlockEntity {
	...
	public void sacrifice(Player player, InteractionHand hand, ItemStack item) {
		...
		if (!itemStack.getItem().equals(ItemInit.VILLAGER_HEART.get()) || DayCountUtility.isBloodySky(player) == true) {
			return;
		}
		...
		player.sendMessage(new TextComponent("The force of the Nether keeps at bay..."), player.getUUID());
	}
