...
public class Bloodjaw extends Monster implements Enemy, HoglinBase {
   private static final EntityDataAccessor<Boolean> DATA_BABY_ID = SynchedEntityData.defineId(Bloodjaw.class, EntityDataSerializers.BOOLEAN);
   private static final int MAX_HEALTH = 85;
   private static final int ATTACK_KNOCKBACK = 2;
   private static final float KNOCKBACK_RESISTANCE = 1f;
   private static final int ATTACK_DAMAGE = 13;
   private static final float BABY_ATTACK_DAMAGE = 2.5F;
   private static final int ATTACK_INTERVAL = 30;
   private static final int BABY_ATTACK_INTERVAL = 10;
   private static final int ATTACK_DURATION = 400;
   private static final float MOVEMENT_SPEED_WHEN_FIGHTING = 0.7F;
   private static final float SPEED_MULTIPLIER_WHEN_IDLING = 0.4F;
   private int attackAnimationRemainingTicks;
   protected static final ImmutableList<? extends SensorType<? extends Sensor<? super Bloodjaw>>> SENSOR_TYPES = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_PLAYERS);
   ...
   private static void initIdleActivity(Brain<Bloodjaw> p_34229_) {
      p_34229_.addActivity(Activity.IDLE, 10, ImmutableList.of(new StartAttacking<Bloodjaw>(Bloodjaw::findNearestValidAttackTarget), new RunSometimes<Bloodjaw>(new SetEntityLookTarget(8.0F), UniformInt.of(30, 60)), new RunOne<Bloodjaw>(ImmutableList.of(Pair.of(new RandomStroll(0.4F), 2), Pair.of(new SetWalkTargetFromLookTarget(0.4F, 3), 2), Pair.of(new DoNothing(30, 60), 1)))));
   }

private static void initFightActivity(Brain<Bloodjaw> p_34237_) {
      p_34237_.addActivityAndRemoveMemoryWhenStopped(Activity.FIGHT, 10, ImmutableList.<net.minecraft.world.entity.ai.behavior.Behavior<net.minecraft.world.entity.Mob>>of(new SetWalkTargetFromAttackTargetIfTargetOutOfReach(1.0F), (net.minecraft.world.entity.ai.behavior.Behavior<net.minecraft.world.entity.Mob>)(net.minecraft.world.entity.ai.behavior.Behavior)new RunIf<Bloodjaw>(Bloodjaw::isAdult, new MeleeAttack(40)), (net.minecraft.world.entity.ai.behavior.Behavior<net.minecraft.world.entity.Mob>)(net.minecraft.world.entity.ai.behavior.Behavior)new RunIf<Bloodjaw>(Bloodjaw::isBaby, new MeleeAttack(15)), new StopAttackingIfTargetInvalid()), MemoryModuleType.ATTACK_TARGET);
   }
   ...
   public static AttributeSupplier.Builder createAttributes() {
      return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 85.0D).add(Attributes.MOVEMENT_SPEED, (double)0.4F).add(Attributes.KNOCKBACK_RESISTANCE, (double)1D).add(Attributes.ATTACK_KNOCKBACK, 2).add(Attributes.ATTACK_DAMAGE, 13);
   }
