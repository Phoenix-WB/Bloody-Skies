...
@OnlyIn(Dist.CLIENT)
public class BloodjawModel<Type extends Bloodjaw & HoglinBase> extends EntityModel<Type> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("leg_back_right", CubeListBuilder.create().texOffs(61, 60).addBox(-14.0F,
				-3.0F, -4.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(6.0F, 16.0F, 17.0F));

		partdefinition.addOrReplaceChild("leg_back_left", CubeListBuilder.create().texOffs(47, 40).addBox(9.0F, -3.0F,
				-4.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.0F, 16.0F, 17.0F));

		partdefinition.addOrReplaceChild("leg_front_right", CubeListBuilder.create().texOffs(58, 0).addBox(-2.0F, -2.0F,
				-3.0F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.0F, 12.0F, -3.0F));

		partdefinition.addOrReplaceChild("leg_front_left", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -2.0F,
				-3.0F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(6.0F, 12.0F, -3.0F));
