...
public class ItemInit {
	...
	public static final RegistryObject<Item> STAINED_SILK = ITEMS.register("stained_silk",
			() -> new Item(new Item.Properties().tab(BloodySkiesCreativeModeTab.BLOODY_SKIES)));

	public static final RegistryObject<Item> BLOOD_CLOTH = ITEMS.register("blood_cloth",
			() -> new Item(new Item.Properties().tab(BloodySkiesCreativeModeTab.BLOODY_SKIES)));
}